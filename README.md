...
You are on **`01-exercise-sql-question-solution`**: the reference SQL for the first Metabase Question exercise. Compare it against your own attempt on `01-exercise-sql-question`.
...
```bash
git switch 01-exercise-sql-question-solution     # then read EXERCISE.md
```
