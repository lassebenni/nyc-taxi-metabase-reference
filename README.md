...
You are on **`02-exercise-dashboard-filter-solution`**: the reference dashboard and date-filter wiring. Compare it against your own attempt on `02-exercise-dashboard-filter`.
...
```bash
git switch 02-exercise-dashboard-filter-solution     # then read EXERCISE.md
```
