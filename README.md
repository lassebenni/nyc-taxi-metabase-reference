...
You are on **`01-exercise-sql-question`**: write a SQL Question against your `fct_trips` mart. The `.sql` in `sql/` is your checkable source of truth; get the query right there, then build the Question in the Metabase UI.

Follow **`EXERCISE.md`** in this branch, then compare against `01-exercise-sql-question-solution`.
